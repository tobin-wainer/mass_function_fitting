...
Included is a Sample MCMC code that Anil gave me that uses M31 velocity dispersion data
...
And also in this folder is the fitting for a simple power law distribution (Power_Law_Distribution_Fitting)
